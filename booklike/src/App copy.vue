...
<template>
	...
	<!-- HEADER -->
	<div class="flex flex-row h-doldur">
		<aside class="sidebar">
			<a class="side-active sidebar-item" href="#">
				<svg
					xmlns="http://www.w3.org/2000/svg"
		...
		<div class="absolute left-56">
			<div class="p-2 flex flex-wrap gap-4">
				<div v-for="i in 20" :key="i" class="grow bg-white rounded-md shadow-md">
					<div class="relative p-3 basis-10">
						<div
							class="absolute max-h-12 w-11/12 text-ellipsis overflow-hidden hover:whitespace-normal hover:overflow-visible hover:!z-20"
						>
							<a href="#" class="font-bold mb-1 bg-white text-gray-600 hover:text-black">Vu3 Dokümantasyon</a>
						</div>
						<div class="flex flex-col mt-14">
							<div class="flex mt-auto justify-center gap-x-1">
								<button class="like-active like-btn group">
									<svg
										xmlns="http://www.w3.org/2000/svg"
								...
								<button class="bookmark-active bookmark-btn group">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										class="fill-current group-hover:text-white"
										enable-background="new 0 0 24 24"
								...
								<div class="relative group">
									<button class="details-btn !-z-[1] group">
										...
										<p class="details-container">
											...
											adipisicing elit. Nam corporis a vel
											consectetur, est, numquam illo exercitationem
											quis necessitatibus quae incidunt mollitia
											minus molestias cum recusandae fugit blanditiis
											debitis! Dignissimos iure suscipit quidem
											perspiciatis animi, ex in accusamus velit illo
											cum ipsa enim, consequatur aut eveniet ab.
											Corrupti, accusamus explicabo?
										</p>
									</button>
								</div>
							</div>
